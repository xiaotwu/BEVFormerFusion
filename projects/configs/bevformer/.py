...
custom_imports = dict(
    imports=[
        ...
        'projects.mmdet3d_plugin.bevformer.modules.petr3d_embedding',
        'projects.mmdet3d_plugin.bevformer.modules.petr3d_hooks',
        'projects.mmdet3d_plugin.bevformer.modules.petr3d_perception',
    ],
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        transformer=dict(
            ...
            petr3d_cfg=dict(
                enabled=True,
                num_queries_total=600, # keep same as num_query above (6 cams * 100)
                q_per_cam=100,
                num_depth_bins=8,
                depth_start=1.0,
                depth_end=60.0,
...
data_root = r'E:/datasets_all/nuscenes/'
...
lr_config = dict(
    ...
    min_lr_ratio=0.1)
#total_epochs = 96
evaluation = dict(interval=69282, pipeline=test_pipeline)

runner = dict(type='IterBasedRunner', max_iters=69282)
...
# Explicitly register IterTimerHook so 'time' and 'data_time' are recorded
custom_hooks = [
    dict(type='IterTimerHook')   # <- this adds data_time and time
]
